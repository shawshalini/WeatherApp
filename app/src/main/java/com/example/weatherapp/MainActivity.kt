...
class MainActivity : AppCompatActivity() {
    ...
    val API:String="bda22929cba12339c9b745b2e36d1e81"
        ...
        override fun doInBackground(vararg p0: String?): String? {
            ...
            override fun onPostExecute(result: String?) {
                ...
                try {
                    ...
                    val CurrDate:String= DateFormat.getDateInstance(DateFormat.FULL).format(updatedAt*1000)
                    ...
                    val cr=CurrDate.split(",")
                    findViewById<TextView>(R.id.info).text=cr[0]
                }
                catch (e: Exception)
                {
                    findViewById<ProgressBar>(R.id.loader).visibility=View.GONE
